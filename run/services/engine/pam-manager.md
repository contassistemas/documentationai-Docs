...
```diff
-       proto "gitlab.com/wevy-run/engine/saas/shared/pam-manager/proto"
...
## JSON Chamada do Serviço
```json
{
  "software_id": "0001", //codigo do software para Engine
  "user": {
    "mail": "mail@mail.com",
    "firstname": "PrimeiroNOme",
    "lastname": "SobreNome",
    "hash_user": "asdfjju213844",
    "hash_run": "09aifafadsjf",
    "profile": ["admin","user"]
        },
  "wevy_id": "ooaidfi28e7e7e7",
  "environment_code": "oaidfi28e7e7e",
  "action": ["create","delete","enable","disable","change","access"],
  "country": "BR",//codigo do pais do cliente
  "region": ["BRA","MEX"] //datacenter
}
```

##JSON retorno serviço
```json
{
  "software_id": "0001", //codigo do software para Engine
  "user": {
  ...
  "country": "BR",//codigo do pais do cliente
  "region": ["BRA","MEX"], //datacenter
  "status": "sucess", //status da acao error / sucess
  "error":{
    "status-code":400,
    "error-code": "Teste",
    "details": "valor"
